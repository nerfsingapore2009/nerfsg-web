    ...
    <div className="min-h-screen">
      <div className="bg-surface border-b border-border">
        <div className="max-w-3xl mx-auto px-5 lg:px-8 py-10">
          ...
          <h1 className="text-3xl md:text-4xl font-bold text-ink mt-1">Contact Us</h1>
          <p className="text-muted mt-2">Have a question or feedback? Fill in the form below.</p>
        </div>
      </div>
      ...
      <div className="max-w-3xl mx-auto px-5 lg:px-8 py-10">
        ...
        <div className="mt-8">
          <p className="text-muted text-sm mb-3">You can also find us on:</p>
          <div className="flex flex-wrap gap-3">
            ...
            >
              ...
              <span className="text-ink font-medium">Facebook Group</span>
            </a>
            <a
